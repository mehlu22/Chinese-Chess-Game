public class ElephantPiece extends ChessPiece implements VerticalMovement, HorizontalMovement, DiagnolMovement
{
   ...
   * from the chesspiece class*/
    public ElephantPiece(String label ,int toRow, int toColumn, ChessGame.Side side,SwingChessBoard chessBoard)
    {
