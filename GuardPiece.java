public class GuardPiece extends ChessPiece implements DiagnolMovement
{
...
// field to store the label of the piece
   ...
   * from the chesspiece class*/
    public GuardPiece(String label ,int toRow, int toColumn, ChessGame.Side side,SwingChessBoard chessBoard)
    {
